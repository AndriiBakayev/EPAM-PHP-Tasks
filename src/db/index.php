    ...
    <table class="table">
        ...
        <tr>
            <th scope="col"><a href="<?= setURL(
                ...
                false
            ) ?>">Name<?= $currentOrder === 'name' ? '&nbsp▼' : ($currentOrder === 'name_desc' ? '&nbsp▲' : '')?>
            </a></th>
            <th scope="col"><a href="<?= setURL(
                'SortBy',
                $currentOrder === 'code' ? 'code_desc' : ($currentOrder === 'code_desc' ? '' : 'code'),
                false
            ) ?>">Code<?= $currentOrder === 'code' ? '&nbsp▼' : ($currentOrder === 'code_desc' ? '&nbsp▲' : '')?>
            </a></th>
            <th scope="col"><a href="<?= setURL(
                'SortBy',
                $currentOrder === 'state' ? 'state_desc' : ($currentOrder === 'state_desc' ? '' : 'state'),
                false
            ) ?>">State<?= $currentOrder === 'state' ? '&nbsp▼' : ($currentOrder === 'state_desc' ? '&nbsp▲' : '')?>
            </a></th>
            <th scope="col"><a href="<?= setURL(
                'SortBy',
                $currentOrder === 'city' ? 'city_desc' : ($currentOrder === 'city_desc' ? '' : 'city'),
                false
            ) ?>">City<?= $currentOrder === 'city' ? '&nbsp▼' : ($currentOrder === 'city_desc' ? '&nbsp▲' : '')?>
            </a></th>
